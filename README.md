# _[Sphinx Riddle](https://github.com/TSiu88/sphinx-riddle)_

#### _C# Dictionaries and Random Method, 02.24.2020_

#### By _**Tiffany Siu and Jack Dunning**_

[![Project Status: Inactive – The project has reached a stable, usable state but is no longer being actively developed; support/maintenance will be provided as time allows.](https://www.repostatus.org/badges/latest/inactive.svg)](https://www.repostatus.org/#inactive)
![LastCommit](https://img.shields.io/github/last-commit/tsiu88/sphinx-riddle)
![Languages](https://img.shields.io/github/languages/top/tsiu88/sphinx-riddle)
...
This application was written in the Epicodus Intro to Programming and C#/React course.  It practices C# dictionaries and using a randomizing method.  This asks the user a riddle in the console and asks for an answer.  It will then tell the user if they were right or wrong.
...
2. Clone the [repository](https://github.com/TSiu88/sphinx-riddle.git) from my [GitHub page](https://github.com/TSiu88)
